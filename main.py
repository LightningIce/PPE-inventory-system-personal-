...
def print_supplier_list(suppliers):
...
def print_hospital_list(hospitals):
...
def receive_item():
    print_item_list(latest_items())
    print_supplier_list(latest_suppliers())
    item_code = input("Enter item code: ").upper().strip()
    if validate_item_code(latest_items(), item_code):
...
def distribute_item():
    print_item_list(latest_items())
    print_hospital_list(latest_hospitals())
    item_code = input("Enter item code: ").upper().strip()
    if validate_item_code(latest_items(), item_code):
